...
pub async fn get_courses_for_tutor(app_state: web::Data<AppState>, path: web::Path<i32>) -> Result<HttpResponse, EzyTutorError> {
...
pub async fn get_course_details(app_state: web::Data<AppState>, path: web::Path<(i32, i32)>,) -> Result<HttpResponse, EzyTutorError> {
...
mod tests {
    ...
    // 유효하지 않은 강의 id를 사용해 강의 상세 정보를 얻는다.
    #[actix_rt::test]
